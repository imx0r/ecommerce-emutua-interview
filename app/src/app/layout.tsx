    ...
    <html lang="en" data-theme="light">
      ...
      >
        ...
        <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10 mt-10">
          <div className="relative flex flex-row justify-between items-center max-w-5xl w-full mx-auto">
            <aside>
              <p>
                <span className="text-xl font-bold">eMutua Digital e-commerce</span>
                <br />
                Desde 2021 desenvolvendo os melhores produtos para você.
              </p>
            </aside>
            <nav>
